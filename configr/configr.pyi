...
class Configr(object):
  ...
  def __repr__(_) -> str: ...
  def __str__(_) -> str: ...
  def loadSettings(_, data:Dict[str,Any] = {}, location:Optional[str] = None, ignores:List[str] = [], clientCodeLocation:str? = None) -> Tuple[Optional[str],Optional[Exception]]: ...
  def saveSettings(_, keys:Optional[List[str]] = None, location:Optional[str] = None, ignores:List[str] = [], clientCodeLocation:str? = None) -> Tuple[Optional[str],Optional[Exception]]: ...
  def keys(_) -> List[str]: ...
